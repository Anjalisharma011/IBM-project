    ...
    <div className="min-h-screen bg-white flex flex-col items-center">
      ...
      <header className="w-full bg-blue-600 text-white flex flex-col items-center justify-center py-20 mt-16 relative">
        ...
        <div className="relative z-10 text-center">
          <h1 className="text-5xl font-bold mb-4 text-stroke">Smart Borrowing Options</h1>
          <p className="text-xl mb-8 max-w-2xl">
            Discover borrowing options that fit your financial needs and goals.
          </p>
        </div>
      </header>

      <section className="w-full max-w-6xl mt-12 p-6">
        <h2 className="text-3xl font-bold mb-8 text-center">Borrowing Solutions</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-gray-100 p-6 rounded-lg shadow-md transform transition-transform duration-200 hover:bg-blue-500 hover:text-white hover:scale-105">
            ...
            <p>Explore various personal loan options to meet your needs.</p>
          </div>
          <div className="bg-gray-100 p-6 rounded-lg shadow-md transform transition-transform duration-200 hover:bg-blue-500 hover:text-white hover:scale-105">
            <h3 className="text-xl font-bold mb-4">Mortgage Loans</h3>
            <p>Find the best mortgage options for your home purchase.</p>
          </div>
          <div className="bg-gray-100 p-6 rounded-lg shadow-md transform transition-transform duration-200 hover:bg-blue-500 hover:text-white hover:scale-105">
            <h3 className="text-xl font-bold mb-4">Credit Management</h3>
            <p>Learn how to manage and improve your credit score.</p>
          </div>
        </div>
      </section>
    </div>
