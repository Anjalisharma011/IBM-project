    ...
    <div className="min-h-screen bg-white flex flex-col items-center">
      ...
      <header className="w-full bg-blue-600 text-white flex flex-col items-center justify-center py-20 mt-16 relative">
        ...
        <div className="relative z-10 text-center">
          <h1 className="text-5xl font-bold mb-4 text-stroke">Smart Spending Strategies</h1>
          <p className="text-xl mb-8 max-w-2xl">
            Learn how to manage your expenses and maximize your savings with effective spending habits.
          </p>
        </div>
      </header>

      <section className="w-full max-w-6xl mt-12 p-6">
        <h2 className="text-3xl font-bold mb-8 text-center">Spending Tips</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-gray-100 p-6 rounded-lg shadow-md transform transition-transform duration-200 hover:bg-blue-500 hover:text-white hover:scale-105">
            <h3 className="text-xl font-bold mb-4">Budgeting</h3>
            <p>Create a realistic budget to track your income and expenses effectively.</p>
          </div>
          <div className="bg-gray-100 p-6 rounded-lg shadow-md transform transition-transform duration-200 hover:bg-blue-500 hover:text-white hover:scale-105">
            <h3 className="text-xl font-bold mb-4">Saving</h3>
            <p>Discover various saving techniques to ensure financial security.</p>
          </div>
          <div className="bg-gray-100 p-6 rounded-lg shadow-md transform transition-transform duration-200 hover:bg-blue-500 hover:text-white hover:scale-105">
            <h3 className="text-xl font-bold mb-4">Debt Management</h3>
            <p>Learn how to manage and reduce your debt for a healthier financial future.</p>
          </div>
        </div>
      </section>
    </div>
